...
parser.add_argument('-f', '--fake_dir',
                    dest="fake_dir",
                    default="../../dataset/mission2_fake_MOUTH_blur_sample/",
...
# 결과 csv 파일을 저장할 디렉토리
output_dir = '../../model_train_code/mission2_labels/'

# 학습용 라벨을 저장할 파일과 테스트용 라벨을 저장할 파일을 생성한다.
train_file = open(output_dir+'train_MOUTH_blur_sample.csv','w')
train_csv = csv.writer(train_file)

test_file = open(output_dir+'test_MOUTH_blur_sample.csv','w')
